<footer class="text-white bg-gray-800">
    <div class="w-full max-w-screen-xl mx-auto">
        <div class="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
            <div>
                <h2 class="mb-6 text-sm font-semibold uppercase text-heading">Company</h2>
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold uppercase text-heading">Help center</h2>
                <ul class="font-medium text-body">
                    <li class="mb-4">
            ...
            <div>
                <h2 class="mb-6 text-sm font-semibold uppercase text-heading">Download</h2>
                <ul class="font-medium text-body">
                    <li class="mb-4">
        ...
        <div class="px-4 py-6 bg-neutral-secondary-soft md:flex md:items-center md:justify-between">
            <span class="text-sm text-body sm:text-center">© 2023 <a href="https://flowbite.com/">Flowbite™</a>. All
                Rights Reserved.
            </span>
            <div class="flex mt-4 space-x-2 sm:justify-center md:mt-0 rtl:space-x-reverse">
