@props(['title', 'author', 'isi', 'created_at', 'category'])


<main class="pt-8 pb-16 antialiased lg:pt-16 lg:pb-24">
    <div class="flex justify-between max-w-screen-2xl ">
        <article class="w-full max-w-2xl mx-auto format format-sm sm:format-base lg:format-lg format-blue ">
            ...
            {{-- Comment Articles Sections --}}
            <section class="mt-10 not-format">
                <div class="flex items-center justify-between mb-6">
                    <h1 class="text-lg font-bold text-gray-900 lg:text-2xl ">Discussion (20)</h1>
                </div>
                <form class="mb-6">
                    <div class="px-4 py-2 mb-4 bg-white border border-gray-200 rounded-lg rounded-t-lg ">
                        <label for="comment" class="sr-only">Your comment</label>
                        <textarea id="comment" rows="6"
                            class="w-full p-2 text-sm text-gray-900 border-0 focus:ring-0 focus:outline-none " placeholder="Write a comment..."
                            required></textarea>
                    </div>
                    <button type="submit"
