      ...
      <nav class="bg-gray-800">
                      ...
                      <div class="hidden md:block">
                          <div class="ml-10 flex items-baseline space-x-4">
                              ...
                              <a href="/" aria-current="page"
                                  class="{{ request()->is('/') ? 'bg-gray-950/50 text-white' : 'bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md  px-3 py-2 text-sm font-medium ">Home</a>
                              <a href="/about"
                                  class="{{ request()->is('/about') ? 'bg-gray-950/50 text-white' : 'bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">About</a>
                              <a href="/blogs"
                                  class="{{ request()->is('/blogs') ? 'bg-gray-950/50 text-white' : 'bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Blogs</a>
                              <a href="/contacts"
                                  class="{{ request()->is('/contacts') ? 'bg-gray-950/50 text-white' : 'bg-gray-950/50 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white ?>' }} rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
                          </div>
                      </div>
                  </div>
                  <div class="hidden md:block">
          ...
          <el-disclosure id="mobile-menu" hidden class="md:hidden [&:not([hidden])]:block">
              <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                  ...
                  <a href="/blogs"
                      class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Blogs</a>
                  <a href="/contact"
